...
namespace CosmosApi
{
    ...
    {
        private readonly List<Action<CosmosApiClientSettings>> _settingConfigurators = new List<Action<CosmosApiClientSettings>>();

        internal CosmosApiBuilder(List<Action<CosmosApiClientSettings>> settingConfigurators)
        {
            for (int i = 0; i < settingConfigurators.Count; ++i)
                _settingConfigurators.Add(settingConfigurators[i]);
        }
        ...
        {
            _settingConfigurators.Add(configurator);
            return new CosmosApiBuilder(_settingConfigurators);
        }
