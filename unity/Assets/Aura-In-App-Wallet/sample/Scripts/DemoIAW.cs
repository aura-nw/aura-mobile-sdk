...
public class DemoIAW : MonoBehaviour
{
    ...
    [SerializeField]
    Button btn_randomWallet, btn_restoreWallet, btn_checkBalance, btn_makeTransaction, btn_transactionHistory, btn_sendNFT;
    [SerializeField]
    GameObject go_mainMenu, go_randomWallet, go_restoreWallet, go_checkBalance, go_makeTransaction, go_transactionHistory, go_sendNFT;
    void Start()
    {
