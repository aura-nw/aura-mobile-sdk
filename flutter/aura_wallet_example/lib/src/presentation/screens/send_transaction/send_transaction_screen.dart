...
import 'package:aura_wallet_example/src/presentation/screens/send_transaction/widgets/fee_slider_widget.dart';
...
import 'package:aura_wallet_example/src/presentation/widgets/app_dialog_provider/app_dialog_base_widget.dart';
import 'package:aura_wallet_example/src/presentation/widgets/text_input_base/text_input_manager.dart';
                    ...
                    children: [
                              ...
                              constraintManager: ConstraintManager()
                                ..notEmpty(
                                  errorMessage: _language.translateWithParam(
                                    LanguageKey
                                        .sendTransactionEmptyErrorMessage,
                                    {
                                      'title': _language.translate(
                                        LanguageKey.sendTransactionAmount,
                                      ),
                                ...
                                ..isNumber(
                                  errorMessage: _language.translate(
                                    LanguageKey
                                        .sendTransactionAmountValidMessage,
                                  ),
                                ),
                      ...
                      SendTransactionIsReadySubmitSelector(
                        builder: (isReady) => InactiveGradientButton(
                          ...
                          onPress: () async {
                            final auraWallet =
                                AppGlobalCubit.of(context).state.auraWallet!;
                            _bloc.add(
