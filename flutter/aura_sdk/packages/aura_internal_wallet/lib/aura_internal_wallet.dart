...
import 'package:aura_internal_wallet/src/aura_internal_wallet_ipml.dart';
...
enum AuraInternalWalletEnvironment {
  mainNet,
  euphoria,
  testNet,
}
...
abstract class AuraInAppWallet {
  factory AuraInAppWallet.create(
      {required AuraInternalWalletEnvironment environment}) {
    return AuraInAppWalletImpl(environment: environment);
  }
...
abstract class AuraWallet {
  final Wallet wallet;
  final AuraInternalWalletEnvironment environment;
