...
class AuraInAppWalletImpl implements AuraInAppWallet {
  final AuraInternalWalletEnvironment environment;

  late NetworkInfo networkInfo;

  AuraInAppWalletImpl({
    this.environment = AuraInternalWalletEnvironment.testNet,
  }) {
    switch (environment) {
...
class AuraWalletImpl extends AuraWallet {
  ...
  Future<String> checkWalletBalance() async {
    String denom = "uaura";
    if (environment == AuraInternalWalletEnvironment.euphoria) {
      denom = 'ueaura';
    }
